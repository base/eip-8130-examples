...
/// @notice BLS12-381 signature authenticator using EIP-2537 precompiles.
///
///         actorId = keccak256(pubKey_G1)  where pubKey_G1 is 128-byte uncompressed G1 point
...
///
/// @dev Minimal transfer of `BLSVerifier` from base/eip-8130 @ 99d4331.
contract BLSAuthenticator is IAuthenticator {
    ...
    function authenticate(bytes32 hash, bytes calldata data) external view returns (bytes32 actorId) {
        ...
        actorId = keccak256(data[256:384]);
